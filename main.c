...
#define MAX 4
#define SPECIALIST 4
void printSpecialistData(char specialist[4][20],float baseFee[],float consultantTime[],int patientCap[]);
...
int patientCap[SPECIALIST]={30,
                            ...
                            12,
                            10};
 printSpecialistData(specialist,baseFee,consultantTime, patientCap);
